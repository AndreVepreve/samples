# Section 6: [RAG (Lewis et al., 2020)](https://arxiv.org/abs/2005.11401) Business Playbook 6.1. RAG Business Playbook: Strategic Deployment Guide
...
## Slide 122: We'll assess options across three models build for full control using [LangChain (LangChain docs)](https://python.langchain.com/docs/introduction/) Croma or Lama by using

We'll assess options across three models build for full control using LangChain Croma or Lama by using
